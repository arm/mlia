...
from mlia.nn.rewrite.core.rewrite import GenericRewrite, SparsityRewrite
from mlia.nn.rewrite.core.train import (
    AUGMENTATION_PRESETS,
    LearningRateSchedule,
    TrainingParameters,
    augment_fn,
    augment_fn_twins,
    detect_activation_from_rewrite_function,
    mixup,
    train,
)
...
def check_train(
    ...
    with TemporaryDirectory() as tmp_dir:
        ...
        assert all(res >= 0.0 for res in result[0][0]), (
