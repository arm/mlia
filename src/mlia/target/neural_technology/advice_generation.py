...
from mlia.target.neural_technology.data_analysis import NXGraphCompilerModelPerformanceAnalyzed
...
class NeuralTechnologyAdviceProducer(FactBasedAdviceProducer):
    ...
    def handle_nx_graph_compiler_performance_analyzed(
        ...
        """Advice for Neural Technology performance estimated by the Neural Accelerator Graph Compiler."""
